...
@Autonomous(name = "cicc", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class crioldcord extends LinearOpMode {
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                ...
                yellowPreDropPose2 = new Pose2d(38, -10, Math.toRadians(180));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        ...
                        purpleDropPose = new Pose2d(-40, -40, Math.toRadians(140));
                        yellowPreDropPose1 = new Pose2d(-35, -10, Math.toRadians(180));
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        ...
                        yellowPreDropPose1 = new Pose2d(-50, -6, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-50,-35,Math.toRadians(90));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(57, -39, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-26, -36, Math.toRadians(40));
                        yellowPreDropPose1 = new Pose2d(-46, -10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-46,-50, Math.toRadians(30));
                        break;
                }
            ...
            //REDRIGHT
            //RED LEFT
            case RedRight:  //Use this case for Robot starting on Red Left
                initPose = new Pose2d(36, -62, Math.toRadians(90)); //Starting pose LEFT
                purplePreDropPose = new Pose2d(36, -40, Math.toRadians(90)); //Pull forward from Start Pose
                //yellowPreDropPose2 = new Pose2d(70, -10, Math.toRadians(180));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(78, -29, Math.toRadians(180));
                        purpleDropPose = new Pose2d(31, -35, Math.toRadians(180));
                        yellowPreDropPose1 = new Pose2d(70, -29, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(36, -30, Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(78, -35, Math.toRadians(180));
                        purpleDropPose = new Pose2d(36, -29, Math.toRadians(90));
                        yellowPreDropPose1 = new Pose2d(70, -32, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(36, -35, Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(78, -42, Math.toRadians(180));
                        purpleDropPose = new Pose2d(42, -36, Math.toRadians(180));
                        yellowPreDropPose1 = new Pose2d(70, -42, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(38, -20, Math.toRadians(90));
                        break;
                }
            ...
            //BLUE LEFT
            case BlueLeft:  //Use this case for Robot starting on Blue Right
                initPose = new Pose2d(36, 62, Math.toRadians(270)); //Starting pose LEFT
                purplePreDropPose = new Pose2d(36, 40, Math.toRadians(270)); //Pull forward from Start Pose
                //yellowPreDropPose2 = new Pose2d(38, 55, Math.toRadians(180));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(78, 44, Math.toRadians(180));
                        purpleDropPose = new Pose2d(41, 35, Math.toRadians(0));
                        yellowPreDropPose1 = new Pose2d(70, 44, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(38, 20, Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(78, 37, Math.toRadians(180));
                        purpleDropPose = new Pose2d(36, 29, Math.toRadians(90));
                        yellowPreDropPose1 = new Pose2d(70, 37, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(34, 35, Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(78, 30, Math.toRadians(90));
                        purpleDropPose = new Pose2d(43, 39, Math.toRadians(180));
                        yellowPreDropPose1 = new Pose2d(70, 30, Math.toRadians(180));
            ...
            case BlueRight:  //Use this case for Robot starting on Blue Right
                ...
                yellowPreDropPose2 = new Pose2d(30, 10, Math.toRadians(180));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(55, 47, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-30, 36, Math.toRadians(321));
                        yellowPreDropPose1 = new Pose2d(-46, 10, Math.toRadians(180));
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        ...
                        yellowPreDropPose1 = new Pose2d(-50, 6, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-50,35,Math.toRadians(270));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(57, 32, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-40, 40, Math.toRadians(230));
                        yellowPreDropPose1 = new Pose2d(-31, 10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-33,44,Math.toRadians(180));
                        break;
                }
    ...
    public void buildParking() {
        //Parking Trajectory
        trajectoryParking = driveTrain.trajectorySequenceBuilder(trajectory6.end())
    ...
    public void selectStartingPosition() {
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData("Park in the middle","(Y)");
            ...
            /*if (gamepad2.y){
                parkPosition = PARK_POSITION.Middle;
            }*/
            telemetry.update();
        }
        telemetry.clearAll();
