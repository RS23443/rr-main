...
@Autonomous(name = "Team 23443 Autonomous 2+0 Center Truss_Singular Trajectory", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class auto23centertruss_singulartrajectory extends LinearOpMode {
    ...
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.START_POSITION startPosition;
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.PARK_POSITION parkPosition;
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.TEAM_ELEMENT_POSITION teamElementPosition;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.CenterStagePipeline());
    ...
    TrajectorySequence trajectoryParking, trajectory1, trajectory2, trajectory3, trajectory4, trajectory5, trajectory6, trajectory7, trajectory8, trajectory9,trajectory10,trajectory11, trajectory12,trajectory13, trajectory14, trajectory15,trajectory16,trajectory17,trajectory18,trajectory19, trajectory20;

    //Initialize any other Pose2d's as desired
    Pose2d initPose; // Starting Pose
    Pose2d preParkPose, parkPosePosition, purplePreDropPose, yellowDropPose, purpleDropPose, yellowPreDropPose1, yellowPreDropPose2, finalPurpleDrop, whitePixel1, WhitePixel2, WhitePixel3, Whitepixel4, comeback,comebcak2,deposit, Whitepixel5,Whitepixel6, comeback3, comeback4,deposit2;
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                ...
                yellowPreDropPose2 = new Pose2d(50, -37, Math.toRadians(180));
                whitePixel1 = new Pose2d (-61,-37, Math.toRadians(180));
                WhitePixel2 = new Pose2d(15,-37, Math.toRadians(180));
                WhitePixel3 = new Pose2d(-61,-37, Math.toRadians(180));
                Whitepixel4 = new Pose2d(-60,-37, Math.toRadians(180));
                comeback = new Pose2d(0,-37, Math.toRadians(180));
                comebcak2 = new Pose2d(30,-37, Math.toRadians(180));
                deposit = new Pose2d(54, -37, Math.toRadians(180));
                ...
                switch (teamElementPosition) {
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(54, -38, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-34, -29, Math.toRadians(90));
                        yellowPreDropPose1 = new Pose2d(2, -37, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-34,-39,Math.toRadians(90));
                        break;
        ...
        trajectory2 = driveTrain.trajectorySequenceBuilder(trajectory1.end())
                .lineToLinearHeading(purpleDropPose)
                .addTemporalMarker(3, () -> {
                    ri.setPosition(0.53);
                    li.setPosition(0.53);
                })
        ...
        trajectory3 = driveTrain.trajectorySequenceBuilder(trajectory2.end())
                ...
                .build();
        // Trajectory 4 is moving towards the stack while the intake is moving
        trajectory4 = driveTrain.trajectorySequenceBuilder(trajectory3.end())
                ...
                .lineToLinearHeading(whitePixel1)


                .build();

        //Trajectory 5 is moving back to Yellow Pose 1 to get ready to drop the two pixels
        ...
        // Trajectory 6 is going to yellow drop pose 2
        ...
        //Trajectory 7 dropping the yellow pixel and white pixel
        trajectory6 = driveTrain.trajectorySequenceBuilder(trajectory5.end())
                ...
                .build();
        //8 os getting ready to go back to the stack
        trajectory7 = driveTrain.trajectorySequenceBuilder(trajectory6.end())
                ...
                .lineToLinearHeading(WhitePixel2,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .build();
        // 9 is moving to the stack while intake and setting position
        trajectory8 = driveTrain.trajectorySequenceBuilder(trajectory7.end())
                ...
                .lineToLinearHeading(WhitePixel3)
            .addTemporalMarker(3,()->{
                sleep(100);
                ri.setPosition(0.42);
                li.setPosition(0.60);
                ...
                .build();
            // 10 is just resetting position to get the last pixel
        //trajectory10 = driveTrain.trajectorySequenceBuilder(trajectory9.end())
                ...
                //})
                //.lineToLinearHeading(Whitepixel4)
                //.build();
        ...
        //trajectory11 = driveTrain.trajectorySequenceBuilder(trajectory10.end())
                //.addTemporalMarker(3, () -> {
                    ...
                    //intake.setPower(0.0);
                //})
                //.lineToLinearHeading(comeback)
                //.build();
        //12 oes back to the yellow predrop pose 2
        trajectory9 = driveTrain.trajectorySequenceBuilder(trajectory8.end())
                .addTemporalMarker(3, () -> {
                    mo.setPosition(0.0);
                    intake.setPower(0.0);
                })
                .lineToLinearHeading(comebcak2)
                .addTemporalMarker(3, () -> {
                ...
                .build();
        //13 goes to drop the 2 white pixels back off
        trajectory10 = driveTrain.trajectorySequenceBuilder(trajectory9.end())
                .addTemporalMarker(3, () -> {
                    sleep(100);
                    mo.setPosition(0.5);
                ...
                .lineToLinearHeading(deposit,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .build();
        // 14 resetts the position to get ready to get more pixel
        trajectory11 = driveTrain.trajectorySequenceBuilder(trajectory10.end())
                .addTemporalMarker(3,()->{
                    lo.setPosition(0);
                    ro.setPosition(1);
                ...
                .lineToLinearHeading(WhitePixel2,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .build();
        // starts the intake and begins the final pixel process 2+4 and 2+5
        trajectory12 = driveTrain.trajectorySequenceBuilder(trajectory11.end())
                ...
                .build();
        //16 just position to get the last pixel for the 2+5
        //trajectory16 = driveTrain.trajectorySequenceBuilder(trajectory15.end())
                //.addTemporalMarker(3, () -> {
                    //sleep(100);
                    //ri.setPosition(0.37);
                    //li.setPosition(0.70);
                ...
                //.lineToLinearHeading(Whitepixel4)
                //.build();
        // 17 goes back to resett the depo position
        //trajectory17 = driveTrain.trajectorySequenceBuilder(trajectory16.end())
                //.addTemporalMarker(3, () -> {
                    //mo.setPosition(0.0);
                    //intake.setPower(0.0);
                //})
                //.lineToLinearHeading(comeback)
                //.build();
        //18 get the finialized deposition position
        trajectory13 = driveTrain.trajectorySequenceBuilder(trajectory12.end())
                ...
                .build();
        // deposits the 2+5
        trajectory14 = driveTrain.trajectorySequenceBuilder(trajectory13.end())
                .addTemporalMarker(3, () -> {
                    sleep(100);
                    mo.setPosition(0.5);
                    sleep(200);
                ...
                .lineToLinearHeading(deposit,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .build();
        // goes into park mode after reseting the robot
        trajectory15 = driveTrain.trajectorySequenceBuilder(trajectory14.end())
                .addTemporalMarker(3,()->{
                    sleep(100);
                    lo.setPosition(0);
                    ro.setPosition(1);
    ...
    public void buildParking() {
        //Parking Trajectory
        trajectoryParking = driveTrain.trajectorySequenceBuilder(trajectory15.end())
    ...
    public void runAutoAndParking() throws InterruptedException {
        ...
        //sleep(200);
        driveTrain.followTrajectorySequence(trajectory14);
        driveTrain.followTrajectorySequence(trajectory15);
        //sleep(200);
        //driveTrain.followTrajectorySequence(trajectory16);
        //sleep(200);
        //driveTrain.followTrajectorySequence(trajectory17);
        //sleep(200);
        //driveTrain.followTrajectorySequence(trajectory18);
        //driveTrain.followTrajectorySequence(trajectory19);
        //driveTrain.followTrajectorySequence(trajectory20);
    ...
    public void selectStartingPosition() {
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad1.b) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.START_POSITION.RedLeft;
                break;
            }
            if (gamepad1.x) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.START_POSITION.BlueRight;
                break;
            }
            if (gamepad1.y) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.START_POSITION.RedRight;
                break;
            }
            if (gamepad1.a) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.START_POSITION.BlueLeft;
                break;
            }
            telemetry.update();
        }
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad2.b) {
                parkPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.PARK_POSITION.Right;
                break;
            }
            if (gamepad2.x) {
                parkPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.PARK_POSITION.Left;
                break;
            }
            telemetry.update();
        }
    ...
    public static class CenterStagePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.TEAM_ELEMENT_POSITION.LeftSpike;
            ...
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.TEAM_ELEMENT_POSITION.MiddleSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
                        input, region2_pointA, region2_pointB, GREEN, -1);
            }
            if (max == avg3)  //Was it the Right Spike
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auto23centertruss.TEAM_ELEMENT_POSITION.RightSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
