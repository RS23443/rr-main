...
@Autonomous(name = "CRI Close", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class criclose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new criclose.CenterStagePipeline());
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedRight:  //Use this case for Robot starting on Red Left
                ...
                switch (teamElementPosition) {
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        ...
                        //yellowPreDropPose1 = new Pose2d(70, -35, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(36, -35, Math.toRadians(170));
                        break;
                ...
                preParkPose = new Pose2d(74, -35, Math.toRadians(180)); // Midway to Park Position
                switch (parkPosition) {
                    case Right:  //Park to the Right of the Backdrop
                        parkPosePosition = new Pose2d(74, -59, Math.toRadians(180));
                        break;
                    case Middle: // park in front of the backdrop
                        parkPosePosition = new Pose2d(74, -37);
                        break;
            ...
            case BlueLeft:  //Use this case for Robot starting on Blue Right
                ...
                preParkPose = new Pose2d(74, 37, Math.toRadians(180)); // Midway to Park Position
                switch (parkPosition) {
                    case Right:  //Park to the Right of the Backdrop
    ...
    public void buildParking() {
        //Parking Trajectory
        trajectoryParking = driveTrain.trajectorySequenceBuilder(trajectory4.end())
    ...
    public void selectStartingPosition() {
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData(" Park on Middle of Backdrop  ", "(A)");
