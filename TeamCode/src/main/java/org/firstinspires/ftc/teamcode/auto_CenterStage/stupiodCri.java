...
@Autonomous(name = "STUPID CRI Close", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class stupiodCri extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new stupiodCri.CenterStagePipeline());
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedRight:
                ...
                //Use this case for Robot starting on Red Left
