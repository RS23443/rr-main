...
@Autonomous(name = "CRI Far", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class crifar extends LinearOpMode {
    ...
    public static crifar.START_POSITION startPosition;
    public static crifar.PARK_POSITION parkPosition;
    public static crifar.TEAM_ELEMENT_POSITION teamElementPosition;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new crifar.CenterStagePipeline());
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                initPose = new Pose2d(-60, -62, Math.toRadians(90)); //Starting pose LEFT
                //purplePreDropPose = new Pose2d(-60, -40, Math.toRadians(90)); //Pull forward from Start Pose
                ...
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        ...
                        purpleDropPose = new Pose2d(-64, -37,Math.toRadians(180));
                        yellowPreDropPose1 = new Pose2d(0, -10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-59, -10, Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(78, -35, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-60, -29, Math.toRadians(90));
                        yellowPreDropPose1 = new Pose2d(-0, -10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-72,-10,Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(78, -42, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-51, -36, Math.toRadians(0));
                        yellowPreDropPose1 = new Pose2d(-0, -10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-58,-10, Math.toRadians(180));
                        break;
                }
            ...
            case BlueRight:  //Use this case for Robot starting on Blue Right
                initPose = new Pose2d(-60, 62, Math.toRadians(270)); //Starting pose LEFT
                ...
                switch (teamElementPosition) {
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        ...
                        purpleDropPose = new Pose2d(-60, 29, Math.toRadians(270));
                        yellowPreDropPose1 = new Pose2d(0, 10, Math.toRadians(180));
                        finalPurpleDrop = new Pose2d(-72, 10, Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
    ...
    public void selectStartingPosition() {
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad1.b) {
                startPosition = crifar.START_POSITION.RedLeft;
                break;
            }
            if (gamepad1.x) {
                startPosition = crifar.START_POSITION.BlueRight;
                break;
            }
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad2.b) {
                parkPosition = crifar.PARK_POSITION.Right;
                break;
            }
            if (gamepad2.x) {
                parkPosition = crifar.PARK_POSITION.Left;
                break;
            }
            if (gamepad2.a){
                parkPosition = crifar.PARK_POSITION.Middle;
                break;
            }
            telemetry.update();
        }
    ...
    public static class CenterStagePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            {
                teamElementPosition = crifar.TEAM_ELEMENT_POSITION.LeftSpike;
            ...
            {
                teamElementPosition = crifar.TEAM_ELEMENT_POSITION.MiddleSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
                        input, region2_pointA, region2_pointB, GREEN, -1);
            }
            if (max == avg3)  //Was it the Right Spike
            {
                teamElementPosition = crifar.TEAM_ELEMENT_POSITION.RightSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
