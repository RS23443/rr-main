...
@Config
@Disabled
@TeleOp(name="phantasmal offset gang", group="LinearOpMode")
public class offsetcri extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            if (gamepad2.left_bumper){
                ...
                sleep(200);
                ro.setPosition(0.04);
                lo.setPosition(0.96); // lowest positioj
                sleep(100);
                umo.setPosition(0.0);
            }
            ...
            //TEST SETPOWER
            if (gamepad1.b){
                flmotor.setPower(1.25 * (0.1));
                blmotor.setPower(-0.1);
                frmotor.setPower(-0.1);
                brmotor.setPower(0.9 * (0.1));
                sleep(3000);
                flmotor.setPower(0);
                blmotor.setPower(0);
                frmotor.setPower(0);
            ...
            blmotor.setPower(1.1 * (y  + rx - x) / denominator * speed);
            frmotor.setPower((y - rx - x) / denominator * speed);
            brmotor.setPower(0.9 * ((y  - rx + x) / denominator * speed));
