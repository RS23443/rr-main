...
@Autonomous(name = "Team 23443 Autonomous 2+3 Center Truss", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class auto23centertruss extends LinearOpMode {
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                ...
                yellowPreDropPose2 = new Pose2d(30, -37, Math.toRadians(180));
                whitePixel1 = new Pose2d (-59,-37, Math.toRadians(180));
                WhitePixel2 = new Pose2d(15,-37, Math.toRadians(180));
                WhitePixel3 = new Pose2d(-59,-37, Math.toRadians(180));
                Whitepixel4 = new Pose2d(-59,-38, Math.toRadians(180));
                comeback = new Pose2d(0,-37, Math.toRadians(180));
                comebcak2 = new Pose2d(30,-37, Math.toRadians(180));
                deposit = new Pose2d(57, -37, Math.toRadians(180));
                ...
                switch (teamElementPosition) {
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(58, -42, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-34, -31, Math.toRadians(90));
            ...
            case BlueRight:  //Use this case for Robot starting on Blue Right
                ...
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(60, 44, Math.toRadians(180));
