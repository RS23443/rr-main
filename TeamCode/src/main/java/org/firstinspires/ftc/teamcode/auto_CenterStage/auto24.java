...
@Autonomous(name = "Team 23443 Autonomous 2+4", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class auto24 extends LinearOpMode {
    ...
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.START_POSITION startPosition;
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.PARK_POSITION parkPosition;
    public static org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.TEAM_ELEMENT_POSITION teamElementPosition;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        webcam.setPipeline(new org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.CenterStagePipeline());
    ...
    TrajectorySequence trajectoryParking, trajectory1, trajectory2, trajectory3, trajectory4, trajectory5, trajectory6, trajectory7, trajectory8, trajectory9, trajectory10,trajectory11, trajectory12, trajectory13, trajectory14 ;

    //Initialize any other Pose2d's as desired
    Pose2d initPose; // Starting Pose
    Pose2d preParkPose, parkPosePosition, purplePreDropPose, yellowDropPose, purpleDropPose, yellowPreDropPose1, yellowPreDropPose2, whitePreDropPose21, whitePreDropPose22, whitePreDropPose23, whitePreDropPose24, whiteDrop1, whiteDrop2, getWhiteDrop3, moveback, WhiteDrop4 ;
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                initPose = new Pose2d(-30, -60, Math.toRadians(90)); //Starting pose LEFT
                purplePreDropPose = new Pose2d(-30, -45, Math.toRadians(90)); //Pull forward from Start Pose
                yellowPreDropPose2 = new Pose2d(30, -10, Math.toRadians(0));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(60, -20, Math.toRadians(0));
                        purpleDropPose = new Pose2d(-45, -20, Math.toRadians(230));
                        yellowPreDropPose1 = new Pose2d(-35, -10, Math.toRadians(0));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(60, -40, Math.toRadians(0));
                        purpleDropPose = new Pose2d(-35, -20, Math.toRadians(315));
                        yellowPreDropPose1 = new Pose2d(-35, -5, Math.toRadians(325));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(60, -50, Math.toRadians(0));
                        purpleDropPose = new Pose2d(-30, -30, Math.toRadians(0));
                        yellowPreDropPose1 = new Pose2d(-45, -10, Math.toRadians(315));
                        break;
                }
                preParkPose = new Pose2d(40, -35, Math.toRadians(0)); // Midway to Park Position
                switch (parkPosition) {
                    case Right:  //Park to the Right of the Backdrop
                        parkPosePosition = new Pose2d(50, -60, Math.toRadians(0));
                        break;
                    case Left:  //Park to the Left of the Backdrop
                        parkPosePosition = new Pose2d(50, -10, Math.toRadians(0));
                        break;
                }
                break;
            ...
            case RedRight:  //Use this case for Robot starting on Red Right
                ...
                purplePreDropPose = new Pose2d(13, -44, Math.toRadians(90)); //Pull forward from Start Pose
                yellowPreDropPose1 = new Pose2d(40, -45, Math.toRadians(180));
                yellowPreDropPose2 = new Pose2d(40, -30, Math.toRadians(180));
                whitePreDropPose21 = new Pose2d(28,-5,Math.toRadians(185));
                whitePreDropPose22 = new Pose2d(-61,-18,Math.toRadians(185));
                whitePreDropPose23 = new Pose2d(-40,-18,Math.toRadians(185));
                whitePreDropPose24 = new Pose2d(0 ,-10,Math.toRadians(185));
                whiteDrop1 = new Pose2d(30,-5,Math.toRadians(180));
                getWhiteDrop3 = new Pose2d(40,-30, Math.toRadians(180));
                moveback = new Pose2d(40,-30,Math.toRadians(180));
                WhiteDrop4 = new Pose2d(54,-30,Math.toRadians(180));



                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(57, -23, Math.toRadians(180));
                        purpleDropPose = new Pose2d(8, -35, Math.toRadians(150));
                        whiteDrop2 = new Pose2d(56,-30,Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(57, -30, Math.toRadians(180));
                        purpleDropPose = new Pose2d(10, -28, Math.toRadians(90));
                        whiteDrop2 = new Pose2d(56,-25,Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(57, -37, Math.toRadians(180));
                        purpleDropPose = new Pose2d(22, -36, Math.toRadians(55));
                        whiteDrop2 = new Pose2d(56,-30,Math.toRadians(180));
                        break;
                }
                preParkPose = new Pose2d(30, -30, Math.toRadians(180)); // Midway to Park Position
                switch (parkPosition) {
                    case Right:  //Park to the Right of the Backdrop
                        parkPosePosition = new Pose2d(50, -60, Math.toRadians(180));
                        break;
                    case Left:  //Park to the Left of the Backdrop
                        parkPosePosition = new Pose2d(50, -10, Math.toRadians(180));
                        break;
                }
                break;
            ...
            case BlueLeft:  //Use this case for Robot starting on Blue Left
                ...
                yellowPreDropPose1 = new Pose2d(40, 45, Math.toRadians(180));
                yellowPreDropPose2 = new Pose2d(40, 30, Math.toRadians(180));
                whitePreDropPose21 = new Pose2d(28, 5, Math.toRadians(175));
                whitePreDropPose22 = new Pose2d(-60, 18, Math.toRadians(175));
                whitePreDropPose23 = new Pose2d(-40,18,Math.toRadians(175));
                whitePreDropPose24 = new Pose2d(0,13,Math.toRadians(175));
                whiteDrop1 = new Pose2d(30,10,Math.toRadians(180));
                moveback = new Pose2d(40,30, Math.toRadians(180));
                getWhiteDrop3 = new Pose2d(40,30, Math.toRadians(180));

                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(56, 42, Math.toRadians(180));
                        purpleDropPose = new Pose2d(18, 38, Math.toRadians(340));
                        whiteDrop2 = new Pose2d(55,30,Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(56, 35, Math.toRadians(180));
                        purpleDropPose = new Pose2d(14, 30, Math.toRadians(270));
                        whiteDrop2 = new Pose2d(55,38,Math.toRadians(180));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(56, 29, Math.toRadians(180));
                        purpleDropPose = new Pose2d(5, 38, Math.toRadians(213));
                        whiteDrop2 = new Pose2d(55,30,Math.toRadians(180));
                        break;
                }
                preParkPose = new Pose2d(43, 40, Math.toRadians(180)); // Midway to Park Position
                switch (parkPosition) {
                    case Right:  //Park to the Right of the Backdrop
                        parkPosePosition = new Pose2d(50, 15, Math.toRadians(180));
                        break;
                    case Left:  //Park to the Left of the Backdrop
                        parkPosePosition = new Pose2d(55, 60, Math.toRadians(180));
                        break;
                }
                break;
            ...
            case BlueRight:  //Use this case for Robot starting on Blue Right
                initPose = new Pose2d(-35, 60, Math.toRadians(270)); //Starting pose LEFT
                purplePreDropPose = new Pose2d(-35, 45, Math.toRadians(270)); //Pull forward from Start Pose
                yellowPreDropPose2 = new Pose2d(55, 10, Math.toRadians(180));
                switch (teamElementPosition) {
                    case LeftSpike:  //team element drop Position 1 (Left)
                        yellowDropPose = new Pose2d(57, 32, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-26, 41, Math.toRadians(324));
                        yellowPreDropPose1 = new Pose2d(-28, 5, Math.toRadians(180));
                        break;
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        yellowDropPose = new Pose2d(60, 40, Math.toRadians(0));
                        purpleDropPose = new Pose2d(-33, 32, Math.toRadians(270));
                        yellowPreDropPose1 = new Pose2d(-40, 10, Math.toRadians(45));
                        break;
                    case RightSpike:  //team element drop Position 3 (Right)
                        yellowDropPose = new Pose2d(57, 32, Math.toRadians(180));
                        purpleDropPose = new Pose2d(-26, 41, Math.toRadians(324));
        ...
        trajectory6 = driveTrain.trajectorySequenceBuilder(trajectory5.end())
                ...
                .lineToLinearHeading(moveback,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/1.5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/1.5))
                .addTemporalMarker(3,() -> {
                    li.setPosition(0.56);
                    ri.setPosition(0.46);
                })
        ...
        trajectory7 = driveTrain.trajectorySequenceBuilder(trajectory6.end())
                .lineToLinearHeading(whitePreDropPose21,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(5,() -> {
                    mastHeightHome();
                    li.setPosition(0.56);
                    ri.setPosition(0.46);
                ...
                .build();
        trajectory8 = driveTrain.trajectorySequenceBuilder(trajectory7.end())
                .lineToLinearHeading(whitePreDropPose22,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .addTemporalMarker(5,() -> {
                    mastHeightHome();
                    li.setPosition(0.58);
                    ri.setPosition(0.47);
                ...
                .build();
        trajectory9 = driveTrain.trajectorySequenceBuilder(trajectory8.end())
                .lineToLinearHeading(whitePreDropPose23,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .addTemporalMarker(5,() -> {
                    mo.setPosition(0);
                    intake.setPower(0);
                })
                .build();
        trajectory10 = driveTrain.trajectorySequenceBuilder(trajectory9.end())
                .lineToLinearHeading(whitePreDropPose24,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .addTemporalMarker(5,() -> {
                    mo.setPosition(0);
                })
                .build();
        trajectory11 = driveTrain.trajectorySequenceBuilder(trajectory10.end())
                .lineToLinearHeading(whiteDrop1,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .addTemporalMarker(5,() -> {
                    intake.setPower(0);
        ...
        trajectory12 = driveTrain.trajectorySequenceBuilder(trajectory11.end())
                .lineToLinearHeading(whiteDrop2)
                .addTemporalMarker(3,() -> {
                    sleep(50);
                    mo.setPosition(0.5);
                ...
                .build();
        trajectory13 = driveTrain.trajectorySequenceBuilder(trajectory12.end())
                .lineToLinearHeading(getWhiteDrop3)
                .addTemporalMarker(8,() -> {
                    lo.setPosition(0);
                    ro.setPosition(1);
                    rightslide.setTargetPosition(-10);
    ...
    public void buildParking() {
        //Parking Trajectory
        trajectoryParking = driveTrain.trajectorySequenceBuilder(trajectory13.end())
                .addTemporalMarker(1,() ->{
                    rightslide.setTargetPosition(-10);
                    leftslide.setTargetPosition(-10);
                })
    ...
    public void runAutoAndParking() throws InterruptedException {
        ...
        sleep(200);
        driveTrain.followTrajectorySequence(trajectory8);
        sleep(200);
        driveTrain.followTrajectorySequence(trajectory9);
        sleep(200);
        driveTrain.followTrajectorySequence(trajectory10);
        sleep(200);
        driveTrain.followTrajectorySequence(trajectory11);
        driveTrain.followTrajectorySequence(trajectory12);
        sleep(200);
        driveTrain.followTrajectorySequence(trajectory13);
    ...
    public void selectStartingPosition() {
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad1.b) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.START_POSITION.RedLeft;
                break;
            }
            if (gamepad1.x) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.START_POSITION.BlueRight;
                break;
            }
            if (gamepad1.y) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.START_POSITION.RedRight;
                break;
            }
            if (gamepad1.a) {
                startPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.START_POSITION.BlueLeft;
                break;
            }
            telemetry.update();
        }
        ...
        while (!isStopRequested()) {
            ...
            if (gamepad2.b) {
                parkPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.PARK_POSITION.Right;
                break;
            }
            if (gamepad2.x) {
                parkPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.PARK_POSITION.Left;
                break;
            }
            telemetry.update();
        }
    ...
    public static class CenterStagePipeline extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.TEAM_ELEMENT_POSITION.LeftSpike;
            ...
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.TEAM_ELEMENT_POSITION.MiddleSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
                        input, region2_pointA, region2_pointB, GREEN, -1);
            }
            if (max == avg3)  //Was it the Right Spike
            {
                teamElementPosition = org.firstinspires.ftc.teamcode.auto_CenterStage.auton2_2.TEAM_ELEMENT_POSITION.RightSpike;
                Imgproc.rectangle( //Draw a Solid Green Box if this is the identified position
