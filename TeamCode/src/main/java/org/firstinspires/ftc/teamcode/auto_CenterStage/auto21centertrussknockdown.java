...
@Autonomous(name = "Team 23443 Autonomous 2+3 Center Truss KnockDown", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class auto21centertrussknockdown extends LinearOpMode {
    ...
    TrajectorySequence trajectoryParking, trajectory1, trajectory2, trajectory3, trajectory4, trajectory5, trajectory6, trajectory7, trajectory8, trajectory9,trajectory10,trajectory11, trajectory12,trajectory13, trajectory14, trajectory15,trajectory16,trajectory17,trajectory18,trajectory19, trajectory20, trajectory21;

    //Initialize any other Pose2d's as desired
    Pose2d initPose; // Starting Pose
    Pose2d preParkPose, parkPosePosition, purplePreDropPose, yellowDropPose, purpleDropPose, yellowPreDropPose1, yellowPreDropPose2, finalPurpleDrop, whitePixel1, WhitePixel2, WhitePixel3, Whitepixel4, comeback,comebcak2,deposit, whiteknock;
    ...
    public void buildAuto() {
        switch (startPosition) {
            ...
            case RedLeft:  //Use this case for Robot starting on Red Left
                ...
                whiteknock = new Pose2d(-61,-46, Math.toRadians(180));
                whitePixel1 = new Pose2d (-62,-28, Math.toRadians(180));
                WhitePixel2 = new Pose2d(15,-37, Math.toRadians(180));
                WhitePixel3 = new Pose2d(-62,-37, Math.toRadians(180));
                ...
                switch (teamElementPosition) {
                    ...
                    case MiddleSpike:  //team element drop Position 2 (Middle)
                        ...
                        purpleDropPose = new Pose2d(-34, -30, Math.toRadians(90));
                    ...
                    case RightSpike:  //team element drop Position 3 (Right)
                        ...
                        purpleDropPose = new Pose2d(-26, -39, Math.toRadians(40));
                        yellowPreDropPose1 = new Pose2d(-35, -58, Math.toRadians(180));
        ...
        trajectory4 = driveTrain.trajectorySequenceBuilder(trajectory3.end())
                ...
                .lineToLinearHeading(whiteknock)
                .build();
        ...
        trajectory7 = driveTrain.trajectorySequenceBuilder(trajectory6.end())
                .lineToLinearHeading(yellowPreDropPose2,SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
                .addTemporalMarker(3, () -> {
                    intake.setPower(0.0);
                    mo.setPosition(0.0);
...
.addTemporalMarker(3,()->{
        ...
        trajectory9 = driveTrain.trajectorySequenceBuilder(trajectory8.end())
                ...
                .lineToLinearHeading(WhitePixel2)
                .build();
        ...
        trajectory18 = driveTrain.trajectorySequenceBuilder(trajectory17.end())
                .addTemporalMarker(3, () -> {
                ...
                .lineToLinearHeading(comebcak2)
                .build();
        trajectory19 = driveTrain.trajectorySequenceBuilder(trajectory18.end())
                .addTemporalMarker(3, () -> {
                    sleep(100);
                    mo.setPosition(0.5);
                    sleep(200);
        ...
        trajectory20 = driveTrain.trajectorySequenceBuilder(trajectory19.end())
                .addTemporalMarker(3,()->{
                    sleep(100);
                    lo.setPosition(0);
                    ro.setPosition(1);
    ...
    public void buildParking() {
        //Parking Trajectory
        trajectoryParking = driveTrain.trajectorySequenceBuilder(trajectory20.end())
