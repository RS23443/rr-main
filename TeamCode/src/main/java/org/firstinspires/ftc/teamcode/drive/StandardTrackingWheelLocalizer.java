...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER =  98873; //0.9938; // multiplier in the x direction
    public static double Y_MULTIPLIER = 1; //0.6239; // multiplier in the y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        backEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "right_back_drive"));
