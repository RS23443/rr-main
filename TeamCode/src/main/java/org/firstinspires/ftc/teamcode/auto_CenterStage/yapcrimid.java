...
@Autonomous(name = "YAP CRI MID", group = "00-Autonomous", preselectTeleOp = "TeleOpMode")
public class yapcrimid extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       // umo.setPosition(0.0);
        ...
        webcam.setPipeline(new yapcrimid.CenterStagePipeline());
